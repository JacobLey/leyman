...
See how those are wired up to implementations in the `lifecycle.json` itself, and tasks can be better understood via [nx-tasks-reference](../../../skills/nx-tasks-reference/AGENTS.md)
...
5. Update [documentation](../../../skills/nx-tasks-reference/AGENTS.md) about task
