import type { AsyncSupplier, GenericClass, InstanceOfClass, InvalidInput, IsClass, LateBinding, LiteralStringType, Supplier } from '#types';
...
type StripNullable<T, A extends AllAnnotations = 'nullable'> = 'nullable' extends A ? ([T] extends [null | infer U] ? U : T) : T;
type StripUndefinable<T, A extends AllAnnotations = 'undefinable'> = 'undefinable' extends A ? ([T] extends [undefined | infer U] ? U : T) : T;
type StripSupplier<T, A extends AllAnnotations = 'supplier'> = 'supplier' extends A 
    ? (
        [T] extends [Supplier<infer U>] 
        ? U 
        : ([T] extends [AsyncSupplier<infer U>] ? U : T)
    ) 
    : T;
type StripLateBinding<T, A extends AllAnnotations = 'latebinding'> = 'latebinding' extends A ? ([T] extends [LateBinding<infer U>] ? U : T) : T;
...
export type ExtraAnnotations<T> = [T] extends [StripAnnotations<T>] ? [] : [InvalidInput<'ExtraAnnotations'>];
...
> {
    ...
    private constructor(
        ...
        childIds: Map<string, HaystackId<any, any, any, any, any, any, any>> = new Map()
    ) {
    ...
    static #annotationKey({ named, nullable, undefinable, supplier, lateBinding }: Annotations<string | symbol | null, boolean, boolean, boolean | 'async', boolean>): string {
    ...
    public named(name?: null): HaystackId<T, Constructor, null, Nullable, Undefinable, Supply, LateBind>;
    ...
    public nullable(nullable: false): HaystackId<T, Constructor, Named, false, Undefinable, Supply, LateBind>;
    public nullable(nullable?: true): HaystackId<T, Constructor, Named, true, Undefinable, Supply, LateBind>;
    ...
    public undefinable(undefinable: false): HaystackId<T, Constructor, Named, Nullable, false, Supply, LateBind>;
    public undefinable(undefinable?: true): HaystackId<T, Constructor, Named, Nullable, true, Supply, LateBind>;
    ...
    public supplier(supplier: false): HaystackId<T, Constructor, Named, Nullable, Undefinable, false, LateBind>;
    public supplier(supplier?: true | {
        sync: true;
        propagateScope: boolean;
    }): HaystackId<T, Constructor, Named, Nullable, Undefinable, true, LateBind>;
    public supplier(supplier: 'async' | {
        sync: false;
        propagateScope: boolean;
    }): HaystackId<T, Constructor, Named, Nullable, Undefinable, 'async', LateBind>;
    public supplier(supplier: boolean | 'async' | {
        sync: boolean;
        propagateScope: boolean;
    } = true) {
        const supplierContext = supplier && (typeof supplier === 'object' ? supplier : { sync: supplier === true, propagateScope: false });
    ...
    public lateBinding(lateBinding: false): HaystackId<T, Constructor, Named, Nullable, Undefinable, Supply, false>;
    public lateBinding(lateBinding?: true): HaystackId<T, Constructor, Named, Nullable, Undefinable, Supply, true>;
    ...
    >(
        idOrNameOrClass?: string | GenericClass<T> | HaystackId<T, Constructor, Named, false, false, false, false>
        ...
        if (idOrNameOrClass) {
            if (typeof idOrNameOrClass === 'string') {
                return new HaystackId<T, Constructor, Named, false, false, false, false>(idOrNameOrClass, null as Constructor);
            }
            ...
            const id = new HaystackId<T, Constructor, Named, false, false, false, false>(idOrNameOrClass.name, idOrNameOrClass as Constructor);
            classToIdCache.set(idOrNameOrClass, id);
            return id;
        }
        
        return new HaystackId<T, Constructor, Named, false, false, false, false>('haystack-id', null as Constructor);
    }
};
...
export type GenericHaystackId = HaystackId<unknown, GenericClass | null, string | symbol | null, boolean, boolean, boolean | 'async', boolean>;
export type GenericOutputHaystackId = HaystackId<unknown, GenericClass | null, string | symbol | null, boolean, boolean, false, false>;

type HaystackIdTypeNullable<Id extends GenericHaystackId> = Id['annotations']['nullable'] extends true
    ? Id[typeof idType] | null
    : Id[typeof idType];
type HaystackIdTypeUndefinable<Id extends GenericHaystackId> = Id['annotations']['undefinable'] extends true
    ? HaystackIdTypeNullable<Id> | undefined
    : HaystackIdTypeNullable<Id>;
type HaystackIdTypeSupplier<Id extends GenericHaystackId> = Id['annotations']['supplier'] extends { sync: infer U }
    ? (
        U extends true 
...
export type HaystackIdType<Id extends GenericHaystackId> = Id['annotations']['lateBinding'] extends true
    ? LateBinding<HaystackIdTypeSupplier<Id>>
    : HaystackIdTypeSupplier<Id>;

export type HaystackIdConstructor<
    Id extends GenericHaystackId
> = Id extends HaystackId<unknown, infer U, string | symbol | null, boolean, boolean, boolean | 'async', boolean>
    ? (U extends GenericClass ? U : null)
    : null;
