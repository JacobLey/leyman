...
import type { GenericClass, DepsClass, ExtendsType, InvalidInput, IsClass, LateBinding, LiteralStringType, Supplier } from '#types';
...
> {
    public constructor(
        ...
        public readonly provider: (...deps: DependencyIdTypes<Dependencies>) => Async extends true
    ...
    public named(name?: null): Binding<
        this['outputId'] extends HaystackId<infer U, infer V, string | symbol | null, infer Nullable, infer Undefinable, false, false>
    ...
    >;
    public named(
        named: string | symbol | null = null,
    ) {
        return new Binding(this.outputId.named(named as ''), this.depIds, this.isAsync, this.provider) as Binding<
            this['outputId'] extends HaystackId<infer U, infer V, string | symbol | null, infer Nullable, infer Undefinable, false, false>
    ...
    public nullable(val?: true): Binding<
        this['outputId'] extends HaystackId<infer U, infer V, infer Named, boolean, infer Undefinable, false, false>
    ...
    public undefinable(val?: true): Binding<
        this['outputId'] extends HaystackId<infer U, infer V, infer Named, infer Nullable, boolean, false, false>
...
type IdOrClassToIds<Dependencies extends readonly (GenericHaystackId | IsClass)[]> = {
    [Index in keyof Dependencies]: Dependencies[Index] extends IsClass
        ...
        : (Dependencies[Index] extends GenericHaystackId ? Dependencies[Index] : never)
};

type ExtendsPromise<T> = T extends Promise<unknown> ? true : false;
type AsyncPromiseOutput<
    OutputId extends GenericHaystackId
> = true extends ExtendsPromise<HaystackIdType<OutputId>> ? [InvalidInput<'AsyncPromiseResponse'>] : [];

const idOrClassToIds = <Dependencies extends readonly (GenericHaystackId | IsClass)[]>(ids: [...Dependencies]): IdOrClassToIds<Dependencies> => {
    return ids.map(id => unsafeIdentifier(id as GenericHaystackId)) as IdOrClassToIds<Dependencies>;
};
...
> {
    ...
    declare public foo: DepsClass<HaystackIdType<OutputId>, DependencyIdTypes<DependencyIds>>;

    public withConstructorProvider(...inputInput: ExtendsType<HaystackIdConstructor<OutputId>, DepsClass<HaystackIdType<OutputId>, DependencyIdTypes<DependencyIds>>>): Binding<OutputId, DependencyIds>;
    public withConstructorProvider(): Binding<OutputId, DependencyIds, false> {
        return new Binding(
            this.#outputId, 
            this.#depIds,
            false,
            (...deps: DependencyIdTypes<DependencyIds>) => new (this.#outputId.construct as DepsClass<HaystackIdType<OutputId>, DependencyIdTypes<DependencyIds>>)(...deps)
        );
    }
    ...
    public withAsyncProvider(
        provider: (...deps: DependencyIdTypes<DependencyIds>) => Promise<HaystackIdType<OutputId>> | HaystackIdType<OutputId>,
        ...invalidInput: AsyncPromiseOutput<OutputId>
    ): Binding<OutputId, DependencyIds, true>;
    public withAsyncProvider(
        ...[provider]: [
            (...deps: DependencyIdTypes<DependencyIds>) => Promise<HaystackIdType<OutputId>> | HaystackIdType<OutputId>,
...
type DependenciesToIds<Dependencies extends readonly unknown[]> = {
    [Index in keyof Dependencies]: HaystackId<
        ...
        string | symbol | null,
        null extends StripAnnotations<Dependencies[Index], 'latebinding' | 'supplier'> ? boolean : false, 
        undefined extends StripAnnotations<Dependencies[Index], 'latebinding' | 'supplier'> ? boolean : false,
        StripAnnotations<Dependencies[Index], 'latebinding'> extends Supplier<unknown> ? true : false,
...
> = IdOrClassToIds<DependencyIds> extends DependenciesToIds<Dependencies> ? [] : [InvalidInput<'DependenciesMismatch'>];
...
> {
    ...
    public withDependencies<DependencyIds extends readonly (GenericHaystackId | IsClass)[]>(
        ...[depIds]: [[...DependencyIds], ...invalidInput: DependenciesMisMatch<DependencyIds, Dependencies>]
    ): Binding<
        OutputId,
    ...
    > {
        return new Binding(
            ...
            false,
            this.#provider as (...args: DependencyIdTypes<IdOrClassToIds<DependencyIds>>) => HaystackIdType<OutputId>
        );
    };
}
...
> {
    #outputId: OutputId;
    #provider: (...deps: [...Dependencies]) => HaystackIdType<OutputId> | Promise<HaystackIdType<OutputId>>;
    public constructor(
        outputId: OutputId,
        provider: (...deps: [...Dependencies]) => HaystackIdType<OutputId> | Promise<HaystackIdType<OutputId>>
    ) {
    ...
    > {
        return new Binding( 
            ...
            idOrClassToIds(depIds),
            true,
            this.#provider as (...args: DependencyIdTypes<IdOrClassToIds<DependencyIds>>) => Promise<HaystackIdType<OutputId>>
        );
    };
}

type MissingConstructorInput = [InvalidInput<'MissingConstructorInput'>]
type MissingConstructorType<T extends GenericHaystackId> = null extends HaystackIdConstructor<T> ? MissingConstructorInput : [];
...
> {
    ...
    public withConstructor(...invalidInput: ExtendsType<HaystackIdConstructor<OutputId>, DepsClass<HaystackIdType<OutputId>, []>>): Binding<OutputId, [], false>;
    ...
    public withConstructorProvider(...invalidInput: MissingConstructorType<OutputId>): ProviderBindingBuilder<
        OutputId, 
    ...
    > {
        return new ProviderBindingBuilder(
            this.#outputId,
            (...args) => new (this.#outputId.construct as DepsClass<HaystackIdType<OutputId>, unknown[]>)(...args)
        );
    }
    ...
    public withAsyncProvider<Dependencies extends readonly unknown[]>(
        ...[provider]: [
            (...deps: [...Dependencies]) => HaystackIdType<OutputId> | Promise<HaystackIdType<OutputId>>,
            ...AsyncPromiseOutput<OutputId>
        ]
    ): AsyncProviderBindingBuilder<
        OutputId, 
        Dependencies
    > {
        return new AsyncProviderBindingBuilder(
            this.#outputId,
            provider
        );
    }
