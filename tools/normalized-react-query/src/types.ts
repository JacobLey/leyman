...
export type QueryData<T extends { [typeCache]: { data: any } }> =
    T[typeof typeCache]['data'];
export type QueryParams<T extends { [typeCache]: { params: any } }> =
    T[typeof typeCache]['params'];
