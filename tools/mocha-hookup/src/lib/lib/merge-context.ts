...
export type MergeContext<Existing extends object, Additional extends AllowableAdditionalContext> = Additional extends object
    ? {
 ...
 */
export const mergeContexts = async <Existing extends object, Additional extends AllowableAdditionalContext>(
    /**
