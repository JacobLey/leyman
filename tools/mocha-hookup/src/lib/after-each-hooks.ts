...
export interface AfterEachChain<
    ...
    AdditionalContext extends AllowableAdditionalContext,
> {
    afterEach: ContextualAfterEachHook<
        MergeContext<ExistingContext, Awaited<AdditionalContext>>
    >;
    teardown: ContextualAfterEachHook<
        MergeContext<ExistingContext, Awaited<AdditionalContext>>
    >;
}
 ...
 */
export const contextualAfterEachGeneratorIdentifier =
    identifier<ContextualAfterEachGenerator>();
 ...
 */
export const entrypointAfterEachIdentifier =
    identifier<EntrypointAfterEachHook>();
